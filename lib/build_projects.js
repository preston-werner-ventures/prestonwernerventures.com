...
// map names of pages to different tile categories when needed
const NAME_TILE_MAP = {
...
const templateize = ({ filename, tiles, ...rest }) => {
  ...
  let filteredTiles = pickTiles(tiles, NAME_TILE_MAP[name] || name, year)
  ...
  return projectTemplate({
    filename,
    name,
    categoryName: NAME_TILE_MAP[name] || name,
